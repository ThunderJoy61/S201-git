...
def index():
    ...
    try:
        ...
        prescriptionsliste = db_session.query(TypePrescription).order_by(TypePrescription.libelle).all()

        resultats_f = []
        montant_total_global = 0
        montant_moyen_global = 0
        territoire_label = ""
        dept = None
        prescriptions = None
        region = None
        ...
        if prescription_id and region_id and year:  
            has_searched = True
        ...
        return render_template(
            ...
            prescriptionsliste=prescriptionsliste,
            regions=regions,
            dept=dept,
            region=region,
